...
SPREE_THRESH, LEAVE_T, SCORE_D, SCORE_C, CARD_THRESH = 7, 3, 1, 0, 5
...
# 89  Banana                    81.8%_11 [9, 2, 0, 0, 0]
# 76  Gacha Funds               66.7%_15 [10, 3, 1, 0, 1]
# 80  ryno                      52.0%_100 [52, 12, 13, 15, 8]
# 75  IELTS5.5                  36.4%_11 [4, 2, 2, 3, 0]
# 87  Burt Picklejuice          27.8%_18 [5, 5, 4, 3, 1]
# 56  Winning team              23.1%_13 [3, 6, 2, 2, 0]
# 112 Team 1                    21.4%_14 [3, 3, 4, 3, 1]
# 66  Team Name                 20.0%_10 [2, 3, 3, 2, 0]
# 90  しかのこのこのここしたんたん            18.2%_11 [2, 6, 2, 0, 1]
# 105 pikachu                   16.7%_12 [2, 1, 3, 1, 5]
# 88  Alpha Team                12.5%_24 [3, 7, 7, 5, 2]
# 93  The Bots                  11.1%_09 [1, 1, 5, 1, 1]
# 63  MIB                       10.5%_19 [2, 3, 5, 5, 4]
# 117 Rolla                     6.7%_15 [1, 1, 4, 3, 6]
# 96  Apex                      5.6%_18 [1, 5, 3, 6, 3]
...
def handle_place_initial_troop(query: QueryPlaceInitialTroop) -> MovePlaceInitialTroop:
    ...
    t = min(border_t, key=lambda x: dist(x, 38))
