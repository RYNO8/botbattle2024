...
# round 2: rip
# 112 Team 1                    66.7%_06 [4, 0, 1, 1, 0]
# 89  Banana                    50.0%_08 [4, 0, 2, 0, 2]
# 76  Gacha Funds               50.0%_10 [5, 1, 3, 0, 1]
# 80  ryno                      44.2%_43 [19, 7, 7, 5, 5]
# 75  IELTS5.5                  33.3%_09 [3, 3, 0, 3, 0]
# 88  Alpha Team                33.3%_06 [2, 1, 2, 1, 0]
# 56  Winning team              25.0%_04 [1, 3, 0, 0, 0]
# 113 BOB                       20.0%_05 [1, 1, 1, 1, 1]
# 87  Burt Picklejuice          16.7%_06 [1, 1, 1, 1, 2]
# 96  Apex                      12.5%_08 [1, 1, 2, 2, 2]
# 105 pikachu                   10.0%_10 [1, 3, 1, 4, 1]
# 61  Existential Birds         9.1%_11 [1, 1, 5, 3, 1]
...
def handle_place_initial_troop(query: QueryPlaceInitialTroop) -> MovePlaceInitialTroop:
    ...
    t = min(border_t, key=lambda x: dist(x, 2))
